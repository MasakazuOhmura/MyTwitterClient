...
public interface MyTimeline<T> {
     ...
     * @param cb callback.
     */
    void next(Long minPosition, final Callback<MyTimelineResult<T>> cb);
     ...
     * @param cb callback.
     */
    void previous(Long maxPosition, final Callback<MyTimelineResult<T>> cb);
}
