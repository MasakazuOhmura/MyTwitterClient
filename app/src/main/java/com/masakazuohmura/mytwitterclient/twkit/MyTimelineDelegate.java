...
public class MyTimelineDelegate<T extends Identifiable> {
     ...
     */
    public MyTimelineDelegate(MyTimeline<T> timeline) {
        this(timeline, null, null);
    }

    MyTimelineDelegate(MyTimeline<T> timeline, DataSetObservable observable, List<T> items) {
        if (timeline == null) {
     ...
     */
    public void refresh(Callback<MyTimelineResult<T>> developerCb) {
     ...
     */
    public void next(Callback<MyTimelineResult<T>> developerCb) {
        loadNext(timelineStateHolder.positionForNext(),
     ...
     */
    void loadNext(Long minPosition, Callback<MyTimelineResult<T>> cb) {
     ...
     */
    void loadPrevious(Long maxPosition, Callback<MyTimelineResult<T>> cb) {
        if (withinMaxCapacity()) {
            if (timelineStateHolder.startTimelineRequest()) {
     ...
     */
    class DefaultCallback extends Callback<MyTimelineResult<T>> {
        protected final Callback<MyTimelineResult<T>> developerCallback;
        protected final MyTimelineStateHolder timelineStateHolder;

        DefaultCallback(Callback<MyTimelineResult<T>> developerCb,
        ...
        @Override
        public void success(Result<MyTimelineResult<T>> result) {
    ...
    class NextCallback extends DefaultCallback {
        ...
        NextCallback(Callback<MyTimelineResult<T>> developerCb,
                     MyTimelineStateHolder timelineStateHolder) {
    ...
    class RefreshCallback extends NextCallback {
        ...
        RefreshCallback(Callback<MyTimelineResult<T>> developerCb,
                        MyTimelineStateHolder timelineStateHolder) {
            super(developerCb, timelineStateHolder);
        }
